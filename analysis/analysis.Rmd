...
base_df <- qol_start %>%
  mutate(
    ...
    hiv = factor(
      ifelse(hiv == 1, "Positive", "Negative"),
...
# save_plot(
#   qol_bin_comp_pl +
#     facet_wrap(~outcome, nrow = 1, labeller = labeller(
#       outcome = c(
#         "PHQ9-S>10" = "PHQ9-S\n>10",
#         "SF12-MCS<42" = "SF12-MCS\n<42",
#         "SF12-PCS<50" = "SF12-PCS\n<50",
#         "6MWT-D<400m" = "6MWT-D\n<400m",
#         "STST-R<20" = "STST-R\n<20",
#         "SGRQ-TS>25" = "SGRG-TS\n>25"
#       )
#     )) +
#     ggtitle("Figure: Proportion of patients with impaired QoL\nat the end of and six months post TB treatment.") +
#     guides(fill = guide_legend(nrow = 2)) +
#     theme(panel.spacing = unit(.1, "cm")),
#   pdf_file = "doc/croi/figure-impaired-qol.png",
#   w = 10.15, h = 10.15
# )
```
